...
// returns daily bars of the close for a symbol over a date range. Weekends and
// holidays are simply absent; downstream alignment resamples and (for FX) falls
// back to the preceding available day.
package yahoo
